 ...
 */
public class MWSProductsException extends MwsException {
    ...
    public MWSProductsException(String message) {
        super(0, message, null);
    }

    public MWSProductsException(String message, int statusCode) {
        super(statusCode, message, null);
    }

    public MWSProductsException(Throwable t) {
        super(0, null, t);
    }

    public MWSProductsException(String message, Throwable t) {
        super(0, message, t);
    }
