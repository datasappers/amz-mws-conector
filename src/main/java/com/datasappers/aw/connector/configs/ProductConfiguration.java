...
public class ProductConfiguration extends Configuration {
    ...
    private @Value("${productServicePath}") String DEFAULT_SERVICE_PATH;;
    ...
    public ProductConfiguration withMaxConnections(int maxConnections) {
        cc.setMaxConnections(maxConnections);
        return this;
    }
    ...
    public ProductConfiguration withMaxErrorRetry(int maxErrorRetry) {
        cc.setMaxErrorRetry(maxErrorRetry);
        return this;
    }
    ...
    public ProductConfiguration withProxyHost(String proxyHost) {
        cc.setProxyHost(proxyHost);
        return this;
    }
    ...
    public ProductConfiguration withProxyPassword(String proxyPassword) {
        cc.setProxyPassword(proxyPassword);
        return this;
    }
    ...
    public ProductConfiguration withProxyPort(int proxyPort) {
        cc.setProxyPort(proxyPort);
        return this;
    }
    ...
    public ProductConfiguration withProxyUsername(String proxyUsername) {
        cc.setProxyUsername(proxyUsername);
        return this;
    }
    ...
    public ProductConfiguration withSignatureVersion(String signatureVersion) {
        cc.setSignatureVersion(signatureVersion);
        return this;
    }
    ...
    public ProductConfiguration withSignatureMethod(String signatureMethod) {
        cc.setSignatureMethod(signatureMethod);
        return this;
    }
    ...
    public ProductConfiguration withUserAgent(String applicationName, String applicationVersion,
    ...
    @PostConstruct
    public void init(){
    	setServiceURL(super.getServiceURL());
    }
    ...
    public ProductConfiguration withServiceURL(String aserviceUrl) {
    ...
    public ProductConfiguration withMaxAsyncQueueSize(int size) {
        cc.setMaxAsyncQueueSize(size);
        return this;
    }
    ...
    public ProductConfiguration withMaxAsyncThreads(int threads) {
        cc.setMaxAsyncThreads(threads);
        return this;
    }
     ...
     */
    public ProductConfiguration withRequestHeader(String name, String value) {
        cc.includeRequestHeader(name, value);
        return this;
    }
